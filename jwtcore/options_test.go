	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithDecryptKey[MyClaims]("another sign key")
			},
...
func TestWithMethod(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithMethod[MyClaims](jwt.SigningMethodHS384)
			},
	...
	tests := []testCase[MyClaims, *MyClaims]{
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithTimeFunc[MyClaims](func() time.Time {
					return nowTime
				})
			},
			want: 1695571200000,
...
func TestWithSetParserOption(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithSetParserOption[MyClaims](opts)
			},
			want: 1,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := len(NewTokenManager[MyClaims](
...
func TestWithAddParserOption(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithAddParserOption[MyClaims](
					fn,
				)
			},
			want: 1,
...
func TestWithIssuer(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithIssuer[MyClaims]("foo")
			},
			want: "foo",
		},
	}
...
func TestWithGenSubjectFunc(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithGenSubjectFunc[MyClaims](
					func() string {
						return "1"
					},
				)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			genSubjectFn := NewTokenManager[MyClaims](
...
func TestWithGenAudienceFunc(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithGenAudienceFunc[MyClaims](
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			genAudienceFn := NewTokenManager[MyClaims](
...
func TestWithGenNotBeforeFunc(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithGenNotBeforeFunc[MyClaims](func() time.Time {
					return nowTime
				})
			},
			want: nowTime,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			genNotBeforeFn := NewTokenManager[MyClaims](
...
func TestWithGenIDFunc(t *testing.T) {
	...
	tests := []testCase[MyClaims, *MyClaims]{
		...
		},
		{
			...
			fn: func() Option[MyClaims, *MyClaims] {
				return WithGenIDFunc[MyClaims](func() string {
					return "unique id"
				})
			},
			want: "unique id",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			genIDFn := NewTokenManager[MyClaims](
